...
net = ( resnet20 resnet32 resnet44 resnet110 resnet56 )
...
# 客户端未添加差分隐私
python fl_train.py --enc --dlg -b 1 --epochs 1 -k 5 --arch resnet56 --dataset cifar100 --seed 1234 --save-dir checkpoints/dlg_enc_res56_5 | tee checkpoints/dlg_enc_res56_5/log.txt
